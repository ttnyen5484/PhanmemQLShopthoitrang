...
namespace DoAnThoiTrang
{
    public class Excel_Export
    {
        ...
        public const string T_HoaDonBanHang = "HoaDonBanHang";
        #endregion
        ...
        private const string V_TONGTIEN = "%TongTien";
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer)
        {
            if (pReplacer != null)
            {
                ...
                pReplacer.Add("%TenNV", "Nguyễn Sỹ Thành");
            }
        }
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_HoaDonBanHang:

                    arrByte = File.ReadAllBytes("HoaDonBanHang.xlsx").ToArray();
                    break;
                    #endregion
            }
            // Get stream
        ...
        public bool ExportHoaDonBanHang(List<HoaDonBanHang> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            //tongSo = dataSource.Count.ToString();ề
            tongTien = dataSource.Sum(t => t.ThanhTien).ToString();
            // Create replacer
            ...
            return OutSimpleReport(dataSource, replacer, "HoaDonBanHang", isPrintPreview, ref fileName);
        }
